...
class UAMFD_Net(nn.Module):
    def __init__(self,
        ...
        checkpoint = torch.load('/home/houjiao/CodeFiles/work/jiqixuexi/mae_pretrain_vit_{}.pth'.format(self.model_size), map_location='cpu')
        ...
        if self.dataset not in english_lists:
            ...
            self.text_model = BertModel.from_pretrained('/home/houjiao/CodeFiles/work/jiqixuexi/BERT/bert-base-chinese/')
        else:
            model_name = 'bert-base-uncased'
            self.text_model = BertModel.from_pretrained('/home/houjiao/CodeFiles/work/jiqixuexi/BERT/bert-base-uncased/')
